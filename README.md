...
flowchart TB
 ...
 subgraph FACTORY["🏭 Factory Layer - CREATE2 Deployment"]
     ...
     Registry["Bot Registry<br>TokenID → Bot Mapping"]
  end
 subgraph BOT["🤖 Bot Instance Layer"]
     BotProxy["Bot Proxy<br>Minimal Clone EIP-1167<br>~10x Gas Savings"]
     BotLogic["Trading Logic<br>• Strategy Engine<br>• Risk Management<br>• Access Control"]
     BotState["Bot State<br>• Performance Metrics<br>• Trade History<br>• Configuration"]
  end
 subgraph NFT["🎨 Ownership Layer - ERC721A"]
 ...
 subgraph WALLET["💰 Wallet Layer"]
     ...
     WalletGuards["Security<br>• Reentrancy Guard<br>• Rate Limiting<br>• Emergency Pause"]
  end
 subgraph TRADE["📈 Trading Layer - Sepolia Testnet"]
     UniV3["Uniswap V3<br>Live Pools<br>Real-time Swaps"]
     Strategy["Trading Strategies<br>• DCA<br>• Arbitrage<br>• Market Making"]
